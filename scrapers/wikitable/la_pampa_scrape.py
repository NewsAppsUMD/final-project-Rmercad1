...
url = 'https://es.wikipedia.org/wiki/Elecciones_provinciales_de_La_Pampa_de_2023'
...
df.columns = ['Date', 'Pollster', 'Sample', 'Frente de Todos', 'Juntos por el Cambio',
             'Comunidad Organizada', 'Frente de Izquierda', 'Others',
...
# Save to CSV
df.to_csv('la_pampa_polls.csv', index=False)